...
export const moduleQuizzesPart3: ModuleQuizQuestion[] = [
  ...
  // ==========================================
  {
    ...
    options: {
      A: "Tornou-se obrigatória a tradução literal de todos os títulos em língua estrangeira para o vernáculo nacional adotado pela biblioteca.",
      B: "Aboliram-se abreviações artificiais do AACR2 (como 'p.', 'il.', 'et al.'), transcrevendo-se os dados tal como constam na fonte.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Número Normalizado Internacional (020), Código Decimal de Classificação (082) e Código de Barras Patrimonial (852).",
      C: "Tipo de Conteúdo (Content Type - 336), Tipo de Mídia (Media Type - 337) e Tipo de Suporte (Carrier Type - 338).",
  ...
  },
  {
    ...
    options: {
      ...
      C: "O RDA manteve a essência rígida da regra de três, limitando-se a elevar a quantidade para no máximo cinco autores por registro.",
      ...
      E: "O RDA eliminou o limite arbitrário, permitindo transcrever todos os criadores e gerar pontos de acesso para quantos forem relevantes."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      A: "texto (336) / computador (337) / recurso online (338), caracterizando a natureza intelectual e o meio digital.",
      ...
      E: "imagem fixa bidimensional (336) / sem mediação humana (337) / volume encadernado padrão (338)."
    },
    correctAnswer: "A",
  ...
  // ==========================================
  {
    ...
    options: {
      A: "Dado Bruto de Pesquisa, Metadado Estruturado, Informação Refinada e Conhecimento Tácito.",
      B: "Autor Intelectual, Casa Editora, Ano Calendário de Publicação e Volume Encadernado.",
      C: "Obra (Work), Expressão (Expression), Manifestação (Manifestation) e Item (Item).",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Um Ponto de Acesso de Assunto Tópico destinado a reunir estudos biográficos e ensaios críticos sobre a literatura brasileira.",
      ...
      E: "Uma nova Expressão (Expression) da mesma Obra original concebida e delimitada intelectualmente por Machado de Assis."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Encontrar (Find), Identificar (Identify), Selecionar (Select) e Obter (Obtain) os recursos desejados.",
      C: "Catalogar com detalhamento, Classificar por disciplinas, Indexar termos autorizados e Dispor na prateleira.",
  ...
  },
  {
    ...
    options: {
      A: "Agente (Agent), subdividido nas entidades Pessoa (Person) e Agente Coletivo (Collective Agent).",
      ...
      D: "Item (Item), correspondente ao exemplar físico individualizado com registro patrimonial.",
  ...
  },
  {
    ...
    options: {
      ...
      D: "Item (Item), corporificação física e singular do exemplar que existe concretamente na estante.",
      E: "Agente Coletivo (Collective Agent), referente à pessoa jurídica depositária do bem móvel."
    },
    correctAnswer: "D",
  ...
  // ==========================================
  {
    ...
    options: {
      A: "Uma letra do alfabeto latino em caixa alta acompanhada de um número cardinal inteiro de três ordens.",
      ...
      E: "3 algarismos arábicos (como 000, 100 ou 530), inserindo-se ponto após o terceiro dígito em expansões analíticas."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Classe 700 (Artes e Recreação) e Classe 800 (Literatura e Retórica de autores).",
      C: "Classe 500 (Ciências Puras e Matemáticas) e Classe 600 (Tecnologia e Ciências Aplicadas).",
      D: "Classe 200 (Religião e Teologia) e Classe 400 (Línguas, Linguística e Idiomas específicos).",
  ...
  },
  {
    ...
    options: {
      A: "Poder ser aplicada autonomamente a qualquer número de assunto do esquema, sem exigir instrução explícita nas tabelas.",
      B: "Servir unicamente para representar nomes geográficos de países e cidades do continente sul-americano em monografias.",
      C: "Exigir compulsoriamente autorização expressa em nota de 'adicione a' no esquema para que o classificador possa empregá-la.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "A Regra do Primeiro na Ordem (First-of-Two Rule), classificando na notação que surgir primeiro nas tabelas (320).",
      C: "O cancelamento formal do processamento técnico com devolução da obra ao departamento requisitante da universidade.",
      D: "A criação de uma notação mista artificial agregando os dois números separados por sinal de adição aritmético.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Reunir alfabeticamente os múltiplos contextos disciplinares de um assunto nas tabelas da CDD, guiando à notação exata.",
      D: "Monitar o calendário acadêmico anual de datas limites para liquidação de taxas e penalidades por atraso.",
      E: "Verificar se determinado usuário ultrapassou a cota limite de títulos autorizados para empréstimo simultâneo."
    },
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Arquitetura cliente-servidor legada que impede o funcionamento em navegadores modernos e conexões públicas de internet.",
      C: "Incompatibilidade formal com os modelos conceituais da IFLA, operando sem suporte a cabeçalhos autorizados de assunto.",
      D: "Software livre de código aberto (GNU/GPL), suporte pleno a MARC 21, Z39.50 e OAI-PMH, interface web e OPAC responsivo.",
  ...
  },
  {
    ...
    options: {
      ...
      D: "Aumentar a massa física e a densidade volumétrica do livro para evitar que exemplares sejam facilmente ocultados.",
      E: "Permitir leitura simultânea de múltiplos itens sem contato físico ou visada óptica, unindo identificação e segurança antifurto."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Padrão ISO 2709 / MARCXML estruturado com codificação de caracteres em UTF-8.",
      ...
      E: "Arquivo gráfico JPEG em baixa resolução com compactação com perdas."
    },
    correctAnswer: "B",
  ...
  // ==========================================
  {
    ...
    options: {
      A: "Desbastamento por obsolescência ➔ Tombamento patrimonial de controle ➔ Determinação do número de autor pela tabela Cutter.",
      ...
      D: "Exame do documento (leitura documentária) ➔ Análise conceitual (identificação dos temas) ➔ Tradução para a linguagem de indexação.",
  ...
  },
  {
    ...
    options: {
      A: "Relação de Equivalência, controlando sinônimos ao remeter do termo não-autorizado para o descritor padrão do tesauro.",
      B: "Relação de causalidade lógica e operacional entre instrumentos tecnológicos e os processos industriais fabris.",
      C: "Relação Hierárquica estrita do tipo todo/parte (partitiva) ou gênero/espécie (genérica) entre classes conceituais.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Resumo Indicativo (ou Descritivo), que apenas aponta os temas sem detalhar conclusões, exigindo ler a obra integral.",
      D: "Sumário Executivo, que sumariza conclusões fiscais e metas estratégicas para subsidiar tomadas imediatas de decisão.",
  ...
  // ==========================================
  {
    ...
    options: {
      A: "Passíveis de alienação comercial plena mediante contrato particular oneroso firmado com conglomerados editoriais.",
      B: "Inalienáveis e irrenunciáveis, permitindo ao autor reivindicar a paternidade da obra e opor-se a alterações indevidas.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "5 anos contados da formalização do contrato de edição comercial firmado entre o autor e a respectiva editora.",
      ...
      E: "70 anos contados a partir de 1º de janeiro do ano subsequente ao do falecimento do autor (regra post mortem autoris)."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      ...
      C: "A alteração imotivada do nome do autor original para atribuir os créditos de autoria ao orientador da pesquisa.",
      D: "A citação de passagens para estudo ou crítica e a cópia de pequenos trechos para uso privado do copista sem lucro.",
  ...
  },
  {
    ...
    options: {
      A: "Não são objeto de proteção autoral, podendo ser reproduzidos, consultados e disseminados livremente pela sociedade.",
      ...
      D: "São resguardados por copyright governamental restrito de titularidade exclusiva dos gabinetes dos tribunais.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "O direito autoral nasce com a criação e dispensa registro; a propriedade industrial depende de concessão pelo INPI.",
      ...
      E: "Os direitos autorais protegem apenas circuitos eletrônicos, enquanto a propriedade industrial protege poemas e prosas."
    },
    correctAnswer: "C",
  ...
  // ==========================================
  {
    ...
    options: {
      A: "Atribuição de prefixo alfanumérico e registro do sufixo persistente de DOI nos servidores da Crossref.",
      B: "Diagramação final e editoração de provas gráficas para envio à gráfica universitária de impressão.",
      C: "Desk Review (ou Desk Reject), triagem preliminar de conformidade temática, escopo e integridade pelo editor.",
  ...
  },
  {
    ...
    options: {
      A: "Ocultar a identidade dos autores dos pareceristas e a dos pareceristas dos autores, mitigando vieses de prestígio e filiação.",
      B: "Publicar o manuscrito instantaneamente na internet sem qualquer avaliação prévia de mérito ou checagem conceitual.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Exige compulsoriamente a impressão mecânica em papel de todos os fascículos antes da visualização na web.",
      D: "Impede deliberadamente a interoperabilidade com motores de busca abertos como o Google Acadêmico e bases SciELO.",
      E: "É uma plataforma aberta que gerencia todo o fluxo editorial (da submissão à publicação online), integrando OAI-PMH."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Fornecer identificador persistente único de 16 dígitos ao pesquisador, resolvendo a desambiguação de nomes de autores.",
      ...
      E: "Substituir os currículos acadêmicos nacionais por um código comercial fechado de monitoramento de produtividade."
    },
    correctAnswer: "B",
