...
export const q51_to_75: Question[] = [
  {
    id: "q51",
    moduleId: "m02",
    ...
    options: {
      A: "A viabilidade econômica e o retorno financeiro do investimento em repositórios digitais em consórcios de bibliotecas privadas.",
      ...
      C: "A preservação da autenticidade, fidedignidade e integridade jurídica de documentos arquivísticos eletrônicos de valor permanente.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "3ª Lei: A cada livro o seu leitor (Every book its reader), que preconiza a divulgação ativa das obras do acervo.",
      C: "2ª Lei: A cada leitor o seu livro (Every reader his/her book), voltada à universalização do atendimento público.",
      D: "4ª Lei: Poupe o tempo do leitor (Save the time of the reader), que orienta a máxima celeridade e eficiência no acesso.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Monografia impressa publicada por editora universitária de prestígio após parecer favorável do conselho editorial.",
      D: "Relatório técnico conclusivo de pesquisa financiada por agência de fomento publicado com ficha catalográfica e ISBN.",
      E: "Conversas acadêmicas, troca de correspondência e debates preliminares de pesquisa no âmbito de um Colégio Invisível."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      A: "Identificar o núcleo central (Core Journals) de periódicos que concentra a maior parte da produção relevante da área.",
      ...
      D: "Mensurar a taxa de obsolescência das monografias e a meia-vida da literatura em ciências humanas para o descarte.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Fontes Secundárias, concebidas para intermediar, organizar e facilitar a recuperação dos documentos primários.",
      ...
      E: "Fontes Cinzentas, de tiragem reduzida e circulação restrita fora do mercado livreiro convencional."
    },
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: {
      A: "Intangibilidade (Intangibility), referente à impossibilidade de o usuário tocar ou pesar fisicamente o serviço antes do uso.",
      B: "Inseparabilidade (Inseparability), refletindo a interação sincrônica direta entre o prestador e o receptor do serviço.",
  ...
  },
  {
    ...
    options: {
      A: "Unificar as diversas variantes de nomes de autores e entidades sob uma forma autorizada padronizada, permitindo a tarefa de Encontrar.",
      B: "Determinar a hierarquia burocrática dos servidores e estabelecer quem possui permissão de acesso físico às salas de arquivo.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Capítulo 7, que orienta a descrição minuciosa de filmes, vídeos cinematográficos e gravações bidimensionais.",
      D: "Capítulo 3, que é o capítulo especializado voltado estritamente à descrição de Materiais Cartográficos.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Tag 505 (Formatted Contents Note), campo padronizado para estruturar sumários e tabelas analíticas de conteúdo.",
      D: "Tag 520, utilizada para a transcrição do resumo informativo ou abstract de artigos de periódicos e teses de mestrado.",
  ...
  },
  {
    ...
    options: {
      A: "Na classe da disciplina cujo autor faleceu há mais tempo, de acordo com as regras de direitos autorais de domínio público.",
      ...
      D: "Na classe de Obras Gerais (000 - Ciência da Computação, Informação e Obras Gerais), por abarcar múltiplas grandes áreas.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Definir os códigos numéricos de países e línguas que compõem com exclusividade as tabelas auxiliares da CDU.",
      ...
      E: "Reunir em ordem alfabética os múltiplos aspectos e contextos disciplinares sob os quais um mesmo assunto é tratado no esquema."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      A: "Relação Associativa (TR / RT - Termo Relacionado), que vincula conceitos de domínios afins que evocam um ao outro.",
      B: "Relação Hierárquica (TG / TE), indicando que o termo Hospital é o gênero taxonômico e Enfermagem é a sua subclasse estrita.",
      C: "Relação de Equivalência (USE / UP), que proíbe o uso do termo enfermagem nas rotinas de busca no catálogo automatizado.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Apropriação indevida de ideias, textos ou dados de outrem, apresentando-os como se fossem de criação intelectual própria.",
      D: "Elaboração de uma resenha crítica contendo a opinião pessoal desfavorável do leitor sobre obra recentemente lançada.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Câmara Brasileira do Livro (CBL), entidade que assumiu a representação oficial da Agência Internacional do ISBN no país.",
      ...
      E: "Fundação de Amparo à Pesquisa do Estado de São Paulo (FAPESP), responsável pelo financiamento de bolsas."
    },
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Depósito Epistemológico Restrito, materiais catalogados sem permissão de cópia reprográfica ou empréstimo entre bibliotecas.",
      D: "Documentação Primária Sigilosa, protegida por segredo de Estado e inacessível à comunidade acadêmica em geral.",
      E: "Literatura Cinzenta (Grey Literature), produção semipublicada ou não convencional que escapa aos canais formais de venda."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Ponto, espaço, travessão e espaço (. - ), sinalizador formal de mudança de área descritiva.",
      D: "Ponto e vírgula precedido e seguido de espaço ( ; ), separador de autores de funções distintas.",
      E: "Dois-pontos antecedidos e sucedidos por espaço em branco ( : ), introdutores do subtítulo."
    },
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: {
      A: "As consultas devem ser restritas aos acadêmicos que possuam projeto de pesquisa formalmente aprovado pelo comitê institucional.",
      ...
      E: "O bibliotecário deve entregar a resposta exata e a informação refinada ao usuário, assumindo integralmente a busca por ele."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Desbastamento Compulsório de Coleções, que elimina registros digitais que não receberam consultas nos últimos dois anos.",
      C: "Linked Data (Dados Conectados) e Web Semântica, permitindo a navegação e interoperabilidade global entre repositórios.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Reservar obrigatoriamente duas posições de caracteres para os Indicadores, ainda que estejam preenchidas por espaços em branco (#).",
      C: "Conter compulsoriamente pelo menos quatro subcampos delimitados por cifrão ($), sob pena de exclusão automática do lote.",
  ...
  },
  {
    ...
    options: {
      A: "CAFe (Comunidade Acadêmica Federada), que unifica o acesso remoto seguro a serviços e coleções digitais de pesquisa.",
      ...
      D: "Plataforma Sucupira, voltada ao acompanhamento e avaliação dos programas de pós-graduação stricto sensu nacionais.",
  ...
  },
  {
    ...
    options: {
      ...
      D: "Creative Commons (como a licença CC-BY), que autoriza a reutilização e compartilhamento sob a condição de atribuição de autoria.",
      E: "Acordo de Confidencialidade Bilateral (NDA), restrito aos membros de laboratórios associados a projetos com a iniciativa privada."
    },
    correctAnswer: "D",
