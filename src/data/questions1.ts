...
export const q1_to_25: Question[] = [
  {
    ...
    options: {
      A: "O Repositório Institucional opera obrigatoriamente sob o protocolo de busca federada Z39.50 para catálogos locais, enquanto a Biblioteca Digital depende unicamente do protocolo OAI-PMH para indexação de conteúdos restritos a redes acadêmicas internas.",
      ...
      C: "A Biblioteca Digital foca na aquisição e disponibilização de coleções comerciais externas para sua comunidade, enquanto o Repositório Institucional foca na custódia, preservação e acesso aberto da produção científica e intelectual gerada pela própria instituição.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "OAI (Open Archive Information), que consiste no pacote reservado para harvesters externos.",
      ...
      E: "AIP (Archival Information Package), que é o pacote arquivístico de preservação permanente."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      A: "A Via Verde (Green Open Access), na qual o autor realiza o autoarquivamento de sua produção em um repositório institucional.",
      ...
      C: "A Via Dourada (Gold Open Access), na qual o artigo é disponibilizado no repositório mediante pagamento de taxa APC.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "CCN (Catálogo Coletivo Nacional de Publicações Seriadas), voltado à localização de acervos.",
      ...
      E: "Portal de Periódicos da CAPES, direcionado à assinatura centralizada de bases comerciais."
    },
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: {
      A: "Just in time (aquisição em lote de obras raras) para o modelo Just in case (intercâmbio exclusivo de cópias reprográficas digitais).",
      B: "Just in case (acesso preventivo baseado na posse física) para o modelo Just in time (acesso ágil no exato momento da demanda).",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Selecionar (Select): escolher um recurso que atenda aos requisitos específicos de conteúdo ou suporte físico.",
      C: "Identificar (Identify): confirmar que a descrição do recurso corresponde à entidade procurada pelo usuário.",
      D: "Navegar (Navigate): explorar conexões e caminhos relacionais entre entidades, obras, autores e assuntos na teia de dados.",
  ...
  },
  {
    ...
    options: {
      A: "Pelo Título próprio da obra, elaborando-se entrada secundária de autor apenas para o primeiro autor mencionado.",
      B: "Pelo nome do coordenador ou organizador geral da edição, mesmo que a publicação não informe essa atribuição formal.",
      C: "Pelo nome do primeiro autor mencionado na folha de rosto, elaborando-se entradas secundárias para os outros três.",
  ...
  },
  {
    ...
    options: {
      ...
      D: "O Sumário detalhado e a introdução da monografia impressa no acervo.",
      E: "A Página de Rosto (Folha de Rosto), que antecede o início do texto da obra."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Diretório (Directory), estruturado em blocos de 12 caracteres para mapear cada campo variável existente.",
      D: "Campo de Controle (00X), reservado para metadados técnicos de processamento e data de catalogação.",
      E: "Indicador (Indicator), formado por dois caracteres que qualificam a leitura dos campos variáveis."
    },
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: {
      A: "Exigem a aplicação das regras ortográficas da ABNT em detrimento das convenções internacionais da Library of Congress.",
      ...
      E: "Não contêm indicadores nem códigos de subcampo delimitados por cifrão ($), sendo compostos por dados posicionais fixos."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      A: "A abolição de abreviaturas latinas artificiais como [S.l.] e [s.n.], substituídas por expressões na língua do catálogo.",
      B: "A manutenção integral da Designação Geral do Material (GMD) no subcampo 245 $h para todos os tipos de documentos.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Item (Item), pois a mudança de editora não impacta o plano das entidades conceituais bibliográficas.",
      D: "Manifestação (Manifestation), por se tratar de uma nova corporificação física/comercial da expressão.",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Res (Coisa), que abrange qualquer entidade ou elemento que possa constituir objeto de pensamento humano.",
      C: "Place (Lugar), que passou a absorver todas as noções de espaço geográfico e conceitual.",
      D: "Nomen (Nome), responsável pela associação entre designações verbais e objetos representados.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "Regra do Primeiro na Ordem (First of Two Rule), classificando o documento na notação que aparecer primeiro.",
      D: "Regra da Conveniência Local, selecionando a classe sugerida pelo usuário que retirou a primeira cópia.",
      E: "Regra da Dupla Notação, imprimindo-se duas etiquetas de chamada para afixação na mesma lombada."
    },
    correctAnswer: "C",
  ...
  },
  {
    ...
    options: {
      ...
      B: "O aumento expressivo no volume de ruído informacional, trazendo dezenas de itens irrelevantes na lista final.",
      C: "A queda substancial na taxa de revocação, provocando um aumento no fenômeno conhecido como Silêncio Documentário.",
  ...
  },
  {
    ...
    options: {
      ...
      C: "A elaboração prévia de um resumo crítico opinativo contendo o juízo de valor do catalogador da universidade.",
      D: "A leitura linear e integral de todas as páginas da obra, da folha de guarda ao colofão tipográfico final.",
      E: "O exame do documento com leitura analítica de suas partes chaves (título, sumário, introdução e conclusões)."
    },
    correctAnswer: "E",
  ...
  },
  {
    ...
    options: {
      ...
      B: "Produto (Product), configurando o conjunto de benefícios, serviços e soluções oferecidos ao usuário.",
      ...
      E: "Praça (Place), definindo os canais físicos e balcões de atendimento onde os livros serão guardados."
    },
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: {
      A: "Demanda Potencial, observada em membros da comunidade acadêmica que nunca frequentaram o espaço da biblioteca.",
      ...
      D: "Demanda Manifesta (ou expressa), que se materializa na formulação de um pedido formal ao sistema ou bibliotecário.",
  ...
  },
  {
    ...
    options: {
      A: "A reprodução, em um só exemplar de pequenos trechos, para uso privado do copista, desde que feita sem intuito de lucro.",
      ...
      D: "A digitalização integral de livros protegidos e sua disponibilização aberta e irrestrita na internet para download.",
