          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start relative">
            ...
            <aside className={`w-full lg:w-88 shrink-0 lg:sticky lg:top-24 max-h-[calc(100vh-8rem)] flex flex-col ${mobileMenuOpen ? 'block' : 'hidden lg:flex'}`}>
              <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-4 flex flex-col h-full overflow-hidden">
                ...
                {/* Category Filter Cards (2x2 Grid) */}
                  ...
                  {CATEGORY_FILTERS.map(f => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-2.5 py-2 rounded-xl text-xs font-bold transition-all text-left flex items-center justify-between border ${
                          isSelected 
                      ...
                      >
                        ...
                        <span className={`text-[10px] font-black px-1.5 py-0.5 rounded-md ml-1 shrink-0 ${
                ...
                <nav className="flex-1 overflow-y-auto space-y-2 pr-1 mt-1">
                      ...
                      return (
                        <button
                          ...
                          className={`group w-full text-left p-3 rounded-2xl text-xs transition-all duration-150 flex items-start gap-3 border ${
                            isActive 
                              ? 'bg-indigo-50/90 border-indigo-300 text-indigo-950 shadow-sm ring-2 ring-indigo-500/20' 
                              : isCompleted
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <h4 className={`text-[13px] leading-snug line-clamp-2 ${
                              isActive ? 'font-black text-indigo-950' : 'font-semibold text-slate-800 group-hover:text-indigo-900'
                            }`}>
